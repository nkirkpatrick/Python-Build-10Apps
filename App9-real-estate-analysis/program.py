...
# basic load using a list, use dictionaries instead
...
def query_data(data):  # list[Purchase]):
    ...
    # Key concept - lambdas (inline methods)

    data.sort(key=lambda p: p.price)

    # print out highest price house
    ...
    # List comprehensions and generator method examples
